...
export default function TestFormCareersPage() {
    ...
    <div className="min-h-screen bg-gray-50 py-10 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-1">Careers</h1>
          <p className="text-gray-500 text-sm">
            {JOBS.length} open roles. Click Apply to open the application dialog.
          </p>
        </div>
...
function ApplyDialog({ job, onClose }: { job: Job; onClose: () => void }) {
  ...
  const submit = async (e: React.FormEvent) => {
    e.preventDefault();
    setSubmitting(true);
    console.log(`[TestCareers:${job.id}] apply`, values);
        ...
        {done ? (
          <div className="p-8 text-center">
            ...
            <p className="text-sm text-gray-500 mb-5">
              Trigger fired for <code>test-careers-{job.id}</code>.
            </p>
            <button
              onClick={onClose}
          ...
          <form onSubmit={submit} className="p-6 space-y-3 overflow-y-auto">
            ...
            <button
              ...
              data-form-id={`test-careers-${job.id}`}
